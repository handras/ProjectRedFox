...
@rpc("call_local", "any_peer", "reliable") func on_tiles_selected(fac_idx, tile_idxs):
	var fac = factories[fac_idx]
	fac.select_tiles(tile_idxs)


@rpc("call_local", "any_peer", "reliable") func on_tiles_unselected(fac_idx, tile_idxs):
	var fac = factories[fac_idx]
...
@rpc("call_local", "any_peer", "reliable") func on_move_tiles_to_dragger(from_fac, tile_idxs):
...
@rpc("call_local", "any_peer", "reliable") func _on_drag_ended_at(fac_id):
...
@rpc("call_local", "reliable") func put_tiles_on_all_clients(state):
